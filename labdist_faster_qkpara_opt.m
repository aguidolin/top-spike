...
% LABDIST_FASTER_QKPARA_OPT(SA,LA,SB,LB,Q,K), parallel in q and k and avoiding "out of memory"-error 
...
%
% Note: if Q is a vector of length n and K is a vector of length m, the
% output is an m-by-n matrix of distances D having at position (i,j)
% the multi-unit distance computed with time precision Q(i) and label
% reassigning parameter K(j)
...
if m2_size>max_size 
    fprintf('m2_size = %d , max_size = 20000000.\n' ,m2_size)
    disp(' ') 
