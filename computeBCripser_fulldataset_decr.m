function BC = computeBCripser_fulldataset_decr(arrayVPM)
%   BC = COMPUTEBCRIPSER_FULLDATASET_DECR(arrayVPM)
%
%   INPUT:
...
%
%   NOTE: uses  computeBCripser(A,'enumeration','decr')
%   to compute the decreasing filtration
%
